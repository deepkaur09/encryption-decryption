...
1. Reads input text from `message.txt`
...
| `message.txt` | Sample input file — place your text here before running |

## How to Run

1. Make sure `message.txt` is in the same folder as the `.java` files
